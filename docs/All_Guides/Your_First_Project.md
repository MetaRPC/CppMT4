...
> **Hands-on Quick Start** - Create a working trading project with MetaTrader 4 and CppMT4 from scratch.
...
```
#include <metarpc/mt4_account.hpp>

// Account ID generation (GetId) and authentication are handled automatically
metarpc::MT4Account account(user, password, grpc_server, apiKey);
