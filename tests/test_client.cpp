...
void testClientLifecycle() {
    metarpc::MT4Client client("mt4.mrpc.pro", 443, "mrpc_test_key");
    assert(!client.isConnected());
    assert(client.getApiKey() == "mrpc_test_key");

    assert(metarpc::MT4Client::computeDeterministicId(12345678, "demo_password") == "6ce74465-7aa9-3a79-2bd8-e40241b50c43");
